...
class MainWindow(QWidget):
    ...
    def GUI(self):
        ...
        grid.addWidget(self.prev_button, 18, 0, 1, 2)#, Qt.AlignVCenter)
        grid.addWidget(self.display_area, 2, 0, 12, 20)  # ,QtCore.Qt.AlignHCenter|QtCore.Qt.AlignVCenter)
        grid.addWidget(self.next_button, 18, 18, 1, 2)#, Qt.AlignVCenter)
        grid.addWidget(self.text_box, 14, 0, 4, 20)
        grid.addWidget(self.restore_button, 19, 0, 1, 2)
        self.save_info = QLabel()
        grid.addWidget(self.save_info, 19, 6, 1, 2)
        grid.addWidget(self.auto_save, 19, 14, 1, 2)
        grid.addWidget(mark_button, 19, 16, 1, 2)
        grid.addWidget(self.save_button, 19, 18, 1, 2)
        self.setLayout(grid)
