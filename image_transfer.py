...
if __name__ == '__main__':
    print(
        baidu_image2str("http://img.51jiaoxi.com/answer-images/9082d2c8-f08e-4588-9049-aab48f29fb24", "characters",
                        "url"))
    print(
        tencent_image2str("http://img.51jiaoxi.com/answer-images/9082d2c8-f08e-4588-9049-aab48f29fb24", "questions",
                          "url"))
